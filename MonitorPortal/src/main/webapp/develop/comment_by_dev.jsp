...
String sql="select * from DropFile where ProjectID='"+ProjectID+"' and DropFileID='"+DropFileID+"'";
...
<table width=1000 border=0 align="center" cellpadding=5 cellspacing=1 bgcolor="#666666" class="tb1" style="FONT-SIZE: 9pt">
      <form method="POST" action="comment_by_dev_do.jsp">
      <input type=hidden name="DropFileID" value="<%=DropFileID%>">
