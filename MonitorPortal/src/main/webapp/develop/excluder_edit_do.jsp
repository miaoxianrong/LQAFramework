...
String excluderName=request.getParameter("excluderName");

String sql="update excluderList set "+"ProjectID='"+ProjectID+"'";
...
sql=sql+",excluderName='"+excluderName+"'";

sql=sql+" where excluderID="+excluderID+" and ProjectID='"+ProjectID+"'";
workM.updateSQL(sql);
workM.close();
