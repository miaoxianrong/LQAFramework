...
<table width=1000 border=0 align="center" cellpadding=5 cellspacing=1 bgcolor="#666666" class="tb1" style="FONT-SIZE: 9pt">
      <form method="POST" action="unique_add_do.jsp" name="kh" onsubmit="return validata();">
      <input type=hidden name="ProjectID" value="<%=ProjectID%>">
    <tbody>
      <tr bgcolor="#C3DBE8"> 
        <td height=25 colspan=2 align=center><span class="zi"><b>Create new unique object</b></span></td>
      </tr>     
      <tr bgcolor="#E8FDFF"> 
      ...
      <tr bgcolor="#F8FDFF"> 
        <td height="25" align=right>My name:</td><td> 
          <input onkeydown=Frm_Down(); name="uniqueName" class="tb" style="WIDTH: 156px"  value="" onkeyup="showHintuniqueName(this.value)">(*)&nbsp;&nbsp;<span id="txtHintuniqueName"></span>
          </td>
      </tr>
