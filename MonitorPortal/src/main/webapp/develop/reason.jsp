...
String DisplayProjectID=ProjectID;
boolean bNotCommon=true;
if(ProjectID.compareTo("00000000")==0){	
	DisplayProjectID="Template";
	bNotCommon=false;
}
//bNotCommon=false;
if(bNotCommon){
...
<form method="POST" action="reason.jsp" name="Maintain" >
  ...
  <tr bgcolor="#C3DBE8"> 
    <td height="25" colspan="5" align=center><span class="zi"><b><%=DisplayProjectID%> - Filter List</b></span></td>
  </tr>
  <tr bgcolor="#F8FDFF"> 
	...
	<a href="reason_import.jsp?ProjectID=<%=ProjectID%>"><IMG alt='import'  border=0 name=22.1.1.6.2 src="images/import.gif"></a>
        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
	&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
	<a href="reason_apply_do.jsp?ProjectID=<%=ProjectID%>"><IMG alt='apply'  border=0 name=22.1.1.6.2 src="images/apply	.gif"></a>
  ...
  <tr bgcolor="#F8FDFF"> 
    ...
    <td width="100" height="25"> 
      <div align="center">Filter</div></td>    
    <td width="100" height="25"> 
      <div align="center">Content</div></td>
    <td width="100" height="25"> 
      <div align="center">Edit</div></td>
    <td width="100" height="25"> 
...
%>
  ...
  <tr bgcolor="#F8FDFF" onmouseover="this.bgColor='#EEF2F4';" onmouseout="this.bgColor='#F8FDFF';"> 
    ...
    <td height="25" bgcolor='#F8CDFF'> 
      ...
      if(iLen>50){
      %>
       <textarea rows="3" name="Content" onFocus=select()  style="WIDTH: 456px">
        <%=Content%> 
       </textarea>
       <%
      }else{
    ...
    <td height="25"> 
      <div align="center"><a href="reason_edit.jsp?ReasonID=<%=ReasonID%>&ProjectID=<%=ProjectID%>">
      <IMG alt='Edit'  border=0 name=22.1.1.6.3 src="images/edit.gif">
      </a></div></td>
    <td height="25"> 
      <div align="center">
