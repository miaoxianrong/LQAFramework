...
if(bSearch){
	...
	sql="select count(*) from ReasonList where ReasonID>0 ";
}
ResultSet RS1=null;
...
<form method="POST" action="reason.jsp" name="Maintain" >
  <tr bgcolor="#C3DBE8"> 
    <td height="25" colspan="4" align=center><span class="zi"><b><%=ProjectID%> Reason List</b></span></td>
  </tr>
  <tr bgcolor="#F8FDFF"> 
	...
	<a href="reason_import_do.jsp?ProjectID=<%=ProjectID%>&TargetProjectID=<%=TargetProjectID%>"><IMG alt='import'  border=0 name=22.1.1.6.2 src="images/import.gif"></a>
      </td>
...
%>
  ...
  <tr bgcolor="#F8FDFF" onmouseover="this.bgColor='#EEF2F4';" onmouseout="this.bgColor='#F8FDFF';"> 
    ...
    <td height="25">
      ...
      <div align="center"><a href="#?../report/total.jsp?ProjectID=00000265&ReasonID=<%=ReasonID%>&NewFuzzyAll=NewFuzzy"><%=NotFoundReason%></a></div>
     
    </td>
    <td height="25" bgcolor='#F8CDFF'> 
      <div align="center"><a href="#?reason_edit.jsp?ReasonID=<%=ReasonID%>&ProjectID=<%=ProjectID%>"><%=Content%></a></div></td>
