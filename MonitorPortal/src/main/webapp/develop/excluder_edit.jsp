...
String ParentName="";
String ParentSeq="";
String sql="select * from excluderList where excluderID="+excluderID;
...
if(rs1.next()){
	...
	excluderName=rs1.getString("excluderName");	
}
rs1.close();
%>
...
<table width=1000 border=0 align="center" cellpadding=5 cellspacing=1 bgcolor="#666666" class="tb1" style="FONT-SIZE: 9pt">
      <form method="POST" action="excluder_edit_do.jsp" name="kh" onsubmit="return validata();">
      <input type=hidden name="ProjectID" value="<%=ProjectID%>">
      <input type=hidden name="excluderID" value="<%=excluderID%>">
    <tbody>
      <tr bgcolor="#C3DBE8"> 
        <td height=25 colspan=2 align=center><span class="zi"><b>Edit Excluder</b></span></td>
      </tr>      
      ...
      <tr bgcolor="#F8FDFF"> 
        <td height="25" align=right>Name:</td><td> 
          <input onkeydown=Frm_Down(); name="excluderName" class="tb" style="WIDTH: 156px"  value="<%=excluderName%>" onkeyup="showHintexcluderName(this.value)">(*)&nbsp;&nbsp;<span id="txtHintexcluderName"></span>
          </td>
      </tr>
