...
%>
<%
String sql_aux=" and LogID>0 ";sql_aux=""; 
workM.getConnection();
String ProjectID="";
...
<form method="POST" action="log.jsp" name="Maintain" >
  <input type=hidden name='ProjectID' value='<%=ProjectID%>'>
  <tr bgcolor="#C3DBE8"> 
    <td height="25" colspan="3" align=center><span class="zi"><b>Log List</b>
    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
    <a href="log_del.jsp?ProjectID=<%=ProjectID%>"><font color=blue>Clear</font></a>
    </span></td>
  </tr>
  <tr bgcolor="#F8FDFF"> 
