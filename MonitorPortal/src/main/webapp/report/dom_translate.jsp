...
String viewNodePath=request.getParameter("NodePath");
if(viewNodePath!=null){
	if(viewNodePath.compareTo("null")!=0){
		if(viewNodePath.compareTo("000")!=0){
			sql_aux=" and NodePath='"+viewNodePath+"' ";
		}
	}
}
workM.getConnection();
...
int iScreenNum=0;
String sql_screen="select count(*) from NodeList where validNode=1 and ProjectID='"+ProjectID+"'";
...
<form method="POST" action="dom_translate.jsp" name="Maintain" >
  <input type=hidden name='ProjectID' value='<%=ProjectID%>'>
  <tr bgcolor="#C3DBE8"> 
    <td height="25" colspan="15" align=left><span class="zi"><b>
    Navigation(<font color=red><B>Coverage: <%=iCoverage3%>%,Screens=<%=iScreenNum%></B></font>):&nbsp;&nbsp;&nbsp;&nbsp;
    <a href='dom_translate.jsp?ProjectID=<%=ProjectID%>'>All</a>
    <%
	...
	if(j==1){
		...
		middleNodePath=middleNodePath+"-"+getSeq;
     	...
     	%>
     	&nbsp;&nbsp;<a href='dom_translate.jsp?ProjectID=<%=ProjectID%>&node=<%=middleNodePath%>'><%=middleNodePath%></a>
     	<%
    }
    %>
    </b></span></td>
  ...
  <tr bgcolor="#F8FDFF"> 
    <td height="25" colspan="15">
		...
		<OPTION value="clickfail">clickfail</OPTION>
  ...
  <tr bgcolor="#F8FDFF"> 
    ...
    <td height="25"><div align="center">Deepth 1</div></td>
    <td height="25"><div align="center">Deepth 2</div></td>
    <td height="25"><div align="center">Deepth 3</div></td>
    <td height="25"><div align="center">Deepth 4</div></td>
    <td height="25"><div align="center">Deepth 5</div></td>
    <td height="25"><div align="center">Deepth 6+</div></td>
    <td height="25"><div align="center">childNum</div></td>  
    <td height="25"><div align="center">Screen</div></td>
    <td height="25"><div align="center">English</div></td> 
    <td height="25"><div align="center">Japanese</div></td> 
    <td height="25"><div align="center">French</div></td>
    <td height="25"><div align="center">German</div></td>
    <td height="25"><div align="center">SChinese</div></td>
    <td height="25"><div align="center">TChinese</div></td>
  </tr>
...
%>
  ...
  <tr bgcolor="<%=bgcolor%>"> 
    ...
    <td height="25"><div align="left">
    	<%if(iLevelID==1){%>
    	<a href='dom_translate.jsp?ProjectID=<%=ProjectID%>&node=<%=NodePath%>'><%=NodePath%></a>
    	<%}%>
    </div></td>
     <td height="25"><div align="left">
    	<%if(iLevelID==2){%>
    ...
    <%if(bSpecial){
    	...
    	<a href='dom_translate.jsp?ProjectID=<%=ProjectID%>&node=<%=NodePath%>&debugging=quick'><font color='<%=runcolor%>'></font></a>
    <%}%>
    </div></td>
    <td height="25"><div align="center">
    <a target=_blank href='<%=DebugServer%>/screen/<%=Feature%><%=screenName%>'><%=screenName%></a></div></td>

    <td height="25"><div align="center"><a target=_blank href="translate.jsp?NodePath=<%=NodePath%>&Lang=English">English</a></div></td> 
    <td height="25"><div align="center"><a target=_blank href="translate.jsp?NodePath=<%=NodePath%>&Lang=Japanese">Japanese</a></div></td> 
    <td height="25"><div align="center"><a target=_blank href="translate.jsp?NodePath=<%=NodePath%>&Lang=French">French</a></div></td>
    <td height="25"><div align="center"><a target=_blank href="translate.jsp?NodePath=<%=NodePath%>&Lang=German">German</a></div></td>
    <td height="25"><div align="center"><a target=_blank href="translate.jsp?NodePath=<%=NodePath%>&Lang=SChinese">SChinese</a></div></td>
    <td height="25"><div align="center"><a target=_blank href="translate.jsp?NodePath=<%=NodePath%>&Lang=TChinese">TChinese</a></div></td>
  </tr>
  <%
  	 }  	
  }
