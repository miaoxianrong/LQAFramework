...
<form method="POST" action="dom_special.jsp" name="Maintain" >
  <input type=hidden name='ProjectID' value='<%=ProjectID%>'>
  <tr bgcolor="#C3DBE8"> 
    <td height="25" colspan="38" align=left><span class="zi"><b>
    Navigation(<font color=red><B>Coverage: <%=iCoverage3%>%,Screens=<%=iScreenNum%></B></font>):&nbsp;&nbsp;&nbsp;&nbsp;
    <a href='dom_special.jsp?ProjectID=<%=ProjectID%>'>All</a>
    <%
	...
	if(j==1){
		...
		middleNodePath=middleNodePath+"-"+getSeq;
     	...
     	%>
     	&nbsp;&nbsp;<a href='dom_special.jsp?ProjectID=<%=ProjectID%>&node=<%=middleNodePath%>'><%=middleNodePath%></a>
     	<%
    }
    %>
    </b></span></td>
  ...
  <tr bgcolor="#F8FDFF"> 
    ...
    <td height="25"><div align="center">value</div></td>   
    ...
    <td height="25"><div align="center">onclick</div></td>
    <td height="25"><div align="center">onkeydown</div></td>
    <td height="25"><div align="center">href</div></td>
    <td height="25"><div align="center">RootURLNodePath</div></td>
    <td height="25"><div align="center">LevelID</div></td>
    <td height="25"><div align="center">seq</div></td>
    <td height="25"><div align="center">Fail times</div></td>
    <td height="25"><div align="center">DOMType</div></td>
    <td height="25"><div align="center">visible</div></td>
    ...
    <td height="25"><div align="center">uniqueObject</div></td>
    <td height="25"><div align="center">Vector</div></td>
  </tr>
...
%>
  ...
  <tr bgcolor="<%=bgcolor%>"> 
    ...
    <td height="25"><div align="left">
    	<%if(iLevelID==1){%>
    	<a href='dom_special.jsp?ProjectID=<%=ProjectID%>&node=<%=NodePath%>'><%=NodePath%></a>
    	<%}%>
    </div></td>
     <td height="25"><div align="left">
    	<%if(iLevelID==2){%>
    ...
    <%if(bSpecial){
    	...
    	<a href='dom_special.jsp?ProjectID=<%=ProjectID%>&node=<%=NodePath%>&debugging=quick'><font color='<%=runcolor%>'></font></a>
    <%}%>
    </div></td>
    ...
    <td height="25"><div align="center"><%=nodeValue%></div></td>
    <td height="25"><div align="center"><%=nodeId%></div></td>
    <td height="25"><div align="center"><%=nodeTitle%></div></td>
    <td height="25"><div align="center">[<%=nodeClass%>]</div></td>    
    <td height="25"><div align="center"><%=onclick%></div></td>
    <td height="25"><div align="center"><%=onkeydown%></div></td>
    <td height="25"><div align="center"><a target=_blank href='<%=nodeHref%>'><%=nodeHref%></a></div></td>
    <td height="25"><div align="center"><%=RootURLNodePath%></div></td>
    <td height="25"><div align="center"><%=LevelID%></div></td>
    <td height="25"><div align="center"><%=seq%></div></td>   
    <td height="25"><div align="center"><%=clicktimes%></div></td>   
    <td height="25"><div align="center"><%=DOMType%></div></td>   
    <td height="25"><div align="center"><%=visible%></div></td>   
    <td height="25"><div align="center"><%=branch%></div></td>     
    <td height="25"><div align="center"><%=mainFeature%></div></td> 
