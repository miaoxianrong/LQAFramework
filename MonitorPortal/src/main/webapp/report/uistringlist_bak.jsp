...
%>
<%
String TextID,Content,NodePath,screenName,Feature,tagName,TagOrURL,nodeHref;
String sql_aux=" and TextID>0 ";sql_aux=""; 
Feature="";screenName="";
workM.getConnection();
...
if(bSearch){
	iOnePage=500;
	sql="select count(*)  from NodeAllText";
...
<form method="POST" action="uistringlist.jsp" name="Maintain" >
  <input type=hidden name='ProjectID' value='<%=ProjectID%>'>
  <tr bgcolor="#C3DBE8"> 
    <td height="25" colspan="4" align=center><span class="zi"><b>LQA Automation Framework</b></span></td>
  </tr>
  <tr bgcolor="#F8FDFF"> 
    <td height="25" colspan="4">
	    <SELECT name=SearchType size=1 class="tb">
		<OPTION value="Content">UI String</OPTION>
  ...
  <tr bgcolor="#C3DBE8"> 
    <td height="25"  align=center><span class="zi"><b>Tag</b></span></td>
    <td height="25"  align=center><span class="zi"><b>xpath</b></span></td>
    <td height="25"  align=center><span class="zi"><b>Screen</b></span></td>
    <td height="25"  align=left><span class="zi"><b>UI String(ResourceBundle)</b></span></td>
  </tr>
...
%>
  <tr bgcolor="<%=bgcolor%>">     
    ...
    %>
    <a target=_blank href='<%=nodeHref%>'><font color='blue'><%=TagOrURL%></font></a>
    <%}%>
    </div></td>
    <td height="25"><div align="center">
    //div/a[@href]
    </div></td>
    <td height="25" width=100><div align="left">
