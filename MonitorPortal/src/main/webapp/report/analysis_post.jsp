...
ResultSet rs=null; String sql=""; int iCoverage=0;
   ...
   sql="select * from ProjectReport where ProjectID='"+ProjectID+"'";
   ResultSet rs31=workM.getURL(sql); 
   if(rs31.next()){
   	ProductComment=rs31.getString("ProductComment");
   }
   rs31.close();
...
<form method="POST" action="navigation.jsp" name="Maintain" >
  ...
  <tr bgcolor="#A3DBE8">     
    ...
    <td height="25"></td>
    <td height="25">
    <a target=_blank href="all_export.jsp?ProjectID=<%=ProjectID%>&ReasonID=-1&InScope=-1&NewFuzzyAll=NewFuzzy&mapped=0&PreAnalysis=0"><font color='blue'>Export</font></a>
    </td>
  </tr>
  ...
  <tr bgcolor="#23DBE8">    
    ...
    <a href="../develop/comment_by_lqa.jsp?ProjectID=<%=ProjectID%>"><IMG alt='confirm'  border=0 src="img/comment.gif"></a>
    </td>
  </tr>
