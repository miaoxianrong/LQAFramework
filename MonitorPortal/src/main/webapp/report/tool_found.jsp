...
<form method="POST" action="tool_found.jsp" name="Maintain" >
  ...
  <tr bgcolor="#C3DBE8"> 
    <td height="25" colspan="4" align=center><span class="zi"><b>Found (by automation)</b></span></td>
  </tr>
  <tr bgcolor="#F8FDFF"> 
  ...
  <tr bgcolor="#C3DBE8"> 
    ...
    <td height="25"  align=center><span class="zi"><b>New/Fuzzy</b></span></td>
...
%>
  <tr bgcolor="<%=bgcolor%>">     
    ...
    <td height="25" width=200><div align="left">   
    <%
    if(mapped.compareTo("1")==0){
    	out.print("mapped");
    }else{
    	out.print("Not found in i18n file");
    }
    %>
    </div></td>
