...
<form method="POST" action="navigation.jsp" name="Maintain" >
  ...
  <tr bgcolor="#C3DBE8"> 
    <td height="25" colspan="4" align=center><span class="zi"><%=ProjectID%> - Not mapped(New/Fuzzy) reason list</span></td>
  </tr>
  <tr bgcolor="<%=bgcolor%>">     
  ...
  <tr bgcolor="#A3DBE8">     
    ...
    <td height="25">
    <a target=_blank href="total.jsp?ProjectID=<%=ProjectID%>&NewFuzzyAll=NewFuzzy&mapped=1"><font color='blue'><%=iMapped%></font></a>
    </td>
  ...
  <tr bgcolor="#A3DBE8">     
    ...
    <td height="25">
    <a target=_blank href="total.jsp?ProjectID=<%=ProjectID%>&NewFuzzyAll=NewFuzzy&mapped=0"><font color='blue'><%=iNotMapped%></font></a>
    </td>
    <td height="25"><%=(100*iNotMapped)/iAll%>%</td>
    <td height="25"></td>
  </tr>
  <tr bgcolor="<%=bgcolor%>">     
    <td height="25"><font color='red'>Unknown reason</font></td>
    <td height="25">
    ...
    <td height="25"><font color='red'>Research</font></td>
  </tr>
  <%
  String EachReasonID="";
  String AllReasonID=",";
  ...
  while(stArray.hasMoreTokens()){
  	...
  	if(rs.next()){
	  	...
	  	<tr bgcolor="<%=bgcolor%>">     
		    ...
		    <td height="25"><font color='green'>Acceptable</font></td>
		</tr>
	  	<%
  	}
  	rs.close();
