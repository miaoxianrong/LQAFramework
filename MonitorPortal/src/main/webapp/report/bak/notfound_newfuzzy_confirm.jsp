...
<form method="POST" action="navigation.jsp" name="Maintain" >
  ...
  <tr bgcolor="#C3DBE8"> 
    <td height="25" colspan="4" align=center><span class="zi"><%=ProjectID%> - New/Fuzzy string list with reason</span></td>
  </tr>    
  <tr bgcolor="<%=bgcolor%>">     
  ...
  <tr bgcolor="#A3DBE8">    
    ...
    Need developers to provide more detail steps to get UIs.<BR>
