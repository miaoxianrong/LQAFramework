...
RootURLNodePath="4"; 
LevelID="2";
String sql_aux=" and screenName<>'' and iTruncated=1 ";
workM.getConnection();
...
int iExecutedNode=0;
String sql_ExecutedNode="select count(*) from NodeList where iTruncated>0 and ProjectID='"+ProjectID+"'";
...
int iHardcodeNum=0;
sql2="select count(*) from NodeList where iTruncated=1 and ProjectID='"+ProjectID+"'";
...
<form method="POST" action="guilist.jsp" name="Maintain" >
  ...
  <tr bgcolor="#C3DBE8"> 
    ...
    <BR>
    Truncated screen:<font color=red><B><%=iHardcodeNum%></B></font>
...
<%  
  ...
  while(RS.next())
  {
	  ...
	  {//·ÖÒ³
	  	...
	  	iTruncated=Integer.parseInt(RS.getString("iTruncated"));	  	
  ...
  <tr bgcolor="<%=bgcolor%>"> 
    <td height="25"> 
     ...
     <td height="25"><div align="left">
    	<a target='rightFrame' href='truncation_screen.jsp?ProjectID=<%=ProjectID%>&NodePath=<%=NodePath%>&screenName=<%=screenName%>'><%=screenName%></a>
    </div></td>
     <td height="25"><div align="left">
    	<%
    	if(iTruncated==1){
