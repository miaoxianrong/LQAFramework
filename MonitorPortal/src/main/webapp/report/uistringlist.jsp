...
%>
<%
String TextID,Content,NodePath,screenName,Feature;
...
<form method="POST" action="uistringlist.jsp" name="Maintain" >
  ...
  <tr bgcolor="#C3DBE8"> 
    <td height="25" colspan="2" align=center><span class="zi"><b>UI String List</b></span></td>
  </tr>
  <tr bgcolor="#F8FDFF"> 
  ...
  <tr bgcolor="#C3DBE8"> 
    ...
    <td height="25"  align=center><span class="zi"><b>UI String</b></span></td>
  </tr>
