...
<form method="POST" action="navigation.jsp" name="Maintain" >
  ...
  <tr bgcolor="<%=bgcolor%>">     
    ...
    <td height="25">
    	<a target=_blank href="total.jsp?ProjectID=<%=ProjectID%>&ReasonID=-1&InScope=-1&mapped=-1&NewFuzzyAll=NewFuzzy&IsBefore=1"><font color='blue'><%=iAll%></font></a>
    </td>
    <td height="25"></td>
    <td height="25"></td>
  </tr> 
  <tr bgcolor="<%=bgcolor%>">     
    ...
    <td height="25">   
    <a target=_blank href='total.jsp?ProjectID=<%=ProjectID%>&ReasonID=0&mapped=-1&NewFuzzyAll=NewFuzzy&InScope=0&IsBefore=1'><font color='red'><%=iInScope%></font></a>
    </td>
  ...
  <tr bgcolor="<%=bgcolor%>">     
    ...
    <td height="25">
    <a target=_blank href='total.jsp?ProjectID=<%=ProjectID%>&ReasonID=0&mapped=-1&NewFuzzyAll=NewFuzzy&InScope=1&IsBefore=1'><font color='blue'><%=iOutScope%></font></a>
    </td>
  ...
  while(stArray.hasMoreTokens()){
  	...
  	if(rs.next()){
	  	...
	  	<tr bgcolor="<%=bgcolor%>">     
		    ...
		    <td height="25">
		    <a target=_blank href='total.jsp?ProjectID=<%=ProjectID%>&mapped=-1&InScope=-1&ReasonID=<%=ReasonID%>&NewFuzzyAll=NewFuzzy&IsBefore=1'><font color='blue'><%=iNumber%></font></a>
		    </td> 
