...
<form method="POST" action="filter1.jsp" name="Maintain" >
  ...
  <tr bgcolor="#C3DBE8"> 
    ...
    <a href='filter1.jsp?ProjectID=<%=ProjectID%>'>All</a>
    <%
	...
	if(j==1){
		...
		middleNodePath=middleNodePath+"-"+getSeq;
     	...
     	%>
     	&nbsp;&nbsp;<a href='filter1.jsp?ProjectID=<%=ProjectID%>&node=<%=middleNodePath%>'><%=middleNodePath%></a>
     	<%
    }
    %>
    </b>&nbsp;&nbsp;&nbsp;&nbsp;
  ...
  <tr bgcolor="#F8FDFF"> 
    ...
    <td height="25"><div align="center">ParentFilter</div></td>
...
%>
    ...
    <td height="25" bgcolor="<%=bgcolor%>"><div align="left">
    	<%if(iLevelID==1){%>
    	<a href='filter1.jsp?ProjectID=<%=ProjectID%>&node=<%=NodePath%>'><%=NodePath%></a>
    	<%}%>
    </div></td>
     <td height="25" bgcolor="<%=bgcolor%>"><div align="left">
    	<%if(iLevelID==2){%>
    ...
    <td height="25"><div align="left">
    	...
    	if(i_name!=-1){
    	%>
    	<a target=_blank href="../develop/xpath_edit_pre.jsp?ProjectID=<%=ProjectID%>&XPATHName=<%=FilterName%>"><font color=blue>Update</font></a>
    	<%
    	}
    	%>
    </div></td>
    ...
    <%if(bSpecial){
    	...
    	<a href='filter1.jsp?ProjectID=<%=ProjectID%>&node=<%=NodePath%>&debugging=quick'><font color='<%=runcolor%>'></font></a>
    <%}%>
    </div></td>
    <td height="25"><div align="center">
