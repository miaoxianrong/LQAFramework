...
<table width=1000 border=0 align="center" cellpadding=5 cellspacing=1 bgcolor="#666666" class="tb1" style="FONT-SIZE: 9pt">
    ...
    <tbody>
      <tr bgcolor="#C3DBE8"> 
        <td height=25 colspan=2 align=center><span class="zi"><b>Download build to <font color='red'>record</font> (Generate tree structure and capture screens)</b></span></td>
      </tr>      
      <tr bgcolor="#E8FDFF"> 
      ...
      <tr bgcolor="#E8FDFF"> 
        ...
        <td><a href="../build/robot/parameter.xml">RunMode=Record|RecordResume</a></td>
      </tr>
       <tr bgcolor="#E8FDFF"> 
