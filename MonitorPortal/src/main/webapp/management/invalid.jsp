...
<table width=1000 border=0 align="center" cellpadding=5 cellspacing=1 bgcolor="#666666" class="tb1" style="FONT-SIZE: 9pt">
    ...
    <tbody>
      <tr bgcolor="#C3DBE8"> 
        <td height=25 colspan=2 align=center><span class="zi"><font size=4>Invalid user - Please try to login again!</font></span></td>
      </tr>      
      <tr bgcolor="#E8FDFF"> 
        <td height="25" align=right>Information: </td>
        <td><font color=red>Password is not correct.</font></td>
      </tr>
     <tr bgcolor="#63DBE8"> 
        <td height=25 colspan=2 align=left><span class="zi">
        <b>Note:</b><br>        
        Please get correct password from Administrator.
        </span></td>
      </tr>   
      </form>
</table>
